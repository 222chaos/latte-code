...
每个 Tool 实现统一接口（[Tool.ts](file:///c:/Users/Administrator/Desktop/free-code-main/src/Tool.ts)）：
...
Tool 注册通过 [tools.ts](file:///c:/Users/Administrator/Desktop/free-code-main/src/tools.ts) 的 `getAllBaseTools()` 完成，支持：
...
每个命令实现 `Command` 接口（[commands.ts](file:///c:/Users/Administrator/Desktop/free-code-main/src/commands.ts)），支持三种类型：
...
项目内置了 Ink 框架的 fork（[src/ink/](file:///c:/Users/Administrator/Desktop/free-code-main/src/ink/)），提供：
...
[scripts/build.ts](file:///c:/Users/Administrator/Desktop/free-code-main/scripts/build.ts) 负责：
