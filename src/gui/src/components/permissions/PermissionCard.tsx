        ...
        >
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 rounded-xl text-[12px] md:text-[13px] font-semibold transition-all active:scale-[0.96]"
              style={{
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 px-3 py-2 rounded-xl text-[12px] md:text-[13px] font-semibold transition-all active:scale-[0.96]"
              style={{
                background: 'var(--card-bg)',
