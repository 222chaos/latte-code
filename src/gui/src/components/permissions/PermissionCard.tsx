...
export default function PermissionCard() {
  ...
  const respond = (requestId: string, behavior: 'allow' | 'deny' | 'always_allow') => {
    send({ type: 'user_permission_response', payload: { requestId, behavior } })
          ...
          >
            ...
            <div className="flex gap-2.5">
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-[12px] text-[13px] font-semibold transition-all"
                style={{
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-[12px] text-[13px] font-semibold transition-all"
                style={{
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 px-3.5 py-2.5 rounded-[12px] text-[13px] font-semibold transition-all"
                style={{
                  background: 'var(--card-bg)',
